...
func (_m *PostRepositoryInterface) CheckUniqueQuotes(postID uint64) (bool, error) {
...
func (_m *PostRepositoryInterface) CheckUniqueRepost(postID uint64) (bool, error) {
	ret := _m.Called(postID)
...
func (_m *PostRepositoryInterface) CountUserTotalPosts(userID uint64) (uint64, error) {
...
func (_m *PostRepositoryInterface) CurrentDayTotalPosts(userID uint64) (int64, error) {
	ret := _m.Called(userID)
...
func (_m *PostRepositoryInterface) Find(postID uint64) (entity.Post, error) {
	ret := _m.Called(postID)
...
func (_m *PostRepositoryInterface) Get(userID uint64, owner string, page uint64, pageSize uint64, startDateFormated *time.Time, endDateFormated *time.Time) ([]entity.Post, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(uint64, string, uint64, uint64, *time.Time, *time.Time) error); ok {
		r1 = rf(userID, owner, page, pageSize, startDateFormated, endDateFormated)
	} else {
		r1 = ret.Error(1)
	}
